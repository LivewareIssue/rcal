...
/* package rcal-0.1.0.0 */
#ifndef VERSION_rcal
#define VERSION_rcal "0.1.0.0"
#endif /* VERSION_rcal */
#ifndef MIN_VERSION_rcal
#define MIN_VERSION_rcal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rcal */
...
#define CURRENT_COMPONENT_ID "rcal-0.1.0.0-inplace-rcal"
